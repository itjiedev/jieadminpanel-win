...
urlpatterns = [
    ...
    path('python/install/<str:version>/', views.PythonInstallView.as_view(), name='python_install'),
    path('python/json/install/', views.InstallView.as_view(), name='install'),
    path('python/uninstall/<str:version>/', views.UninstallView.as_view(), name='uninstall'),
    path('python/del/', views.PythonDeleteView.as_view(), name='delete'),
    path('python/name/edit/<str:uuid>/', views.NameEditView.as_view(), name='name_edit'),
